...
import bgImage from '../assets/entree 1.jpg';
...
const Hero = () => {
  ...
  const teamMembers = [
    {
      role: "Chef d'équipe",
      name: "Mouloud Koudil",
      description: "je ne sais pas quoi aussi",
      occupation: "responsable de l'ecole",
      image: koudilImage
    },
    {
  ...
  useEffect(() => {
    if (statsInView) {
      ...
      const increment = targetNumber / framesCount;
      let frame = 0;

      const animate = () => {
        if (frame < framesCount) {
          setCounters(prev => prev.map(() => Math.min(Math.ceil(increment * frame), targetNumber)));
          frame++;
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <nav className="sticky top-0 w-full z-50 bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
              {/* Login Button */}
              <button className="hidden md:block bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300">
                Se connecter
              </button>
        ...
        <div className={`${isMenuOpen ? 'block' : 'hidden'} md:hidden bg-white border-t`}>
          <div className="px-4 py-2 space-y-3">
            ...
            <button className="w-full bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 hover:shadow-lg transition-all duration-300">
              Se connecter
            </button>
          </div>
        </div>
      ...
      <main className="flex-grow relative">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-white text-center font-poppins px-4">
          ...
          <button className="bg-blue-500 hover:bg-blue-600 px-8 py-3 rounded-lg flex items-center gap-2 transition-all duration-300">
            Voir plus
            <IoMdSearch />
          </button>
        </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {counters.map((count, index) => (
              ...
              >
                <div className="bg-[hsla(204,76%,40%,1)] text-white rounded-lg p-4">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center w-full">
              ...
              <div className="w-full max-w-md mx-auto">
                <img 
                  src={chartImage} 
                  alt="Publications Statistics" 
                  className="w-full h-auto"
                />
                <h4 className="text-center text-lg font-medium mt-2">Publications</h4>
              </div>
      ...
      <footer className="bg-[hsla(204,76%,40%,1)] text-white">
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="border-t border-white/20 mt-8 pt-8 text-center">
            <p>&copy; {new Date().getFullYear()} LMCS. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
